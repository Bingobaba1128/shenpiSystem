    ...
    <div style="padding: 0 15px">
      <el-tabs type="border-card">
        <el-tab-pane label="客户档案">
          <!-- 检索区 -->
          <el-scrollbar style="height: calc(100vh - 295px);">

            <el-row :gutter="10" style="margin-left:0;margin-right:0" class="specialSelect">
              <el-form :inline="true" :rules="rules" :model="queryInfo" label-position="right" class="demo-form-inline" label-width="150px">
                <el-row>
                  <el-col :span="6">
