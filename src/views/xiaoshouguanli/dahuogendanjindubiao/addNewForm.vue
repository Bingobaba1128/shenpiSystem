      ...
      <el-tabs type="border-card">
        <el-tab-pane label="销售合同">
          ...
          <el-row style="padding:0 10px;display: flex; flex-direction:column;height:80%">
            <el-table :data="listD" border style="height:100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
        ...
        <el-tab-pane label="相关附件">
          ...
          <el-table :data="listPE" border style="height:100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
            <el-table-column type="index" label="序号" width="100" />
