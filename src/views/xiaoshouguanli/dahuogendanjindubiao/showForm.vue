      ...
      <el-tabs type="border-card">
        <el-tab-pane label="销售合同">
              ...
              <el-row>
                <el-col :span="24" class="fullWidth">
                  <el-form-item label="备注:">
                    <el-input v-model="queryInfo.remark" placeholder="" disabled />
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
          ...
          <el-row style="padding:0 10px;display: flex; flex-direction:column;height:80%">
            <el-table :data="queryInfo.listD" border style="height:100%" :span-method="objectSpanMethod" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
              ...
              <el-table-column label="单价（元/含税）" prop="price" width="150">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.price" placeholder="" type="number" disabled @mousewheel.native.prevent />
                </template>
              </el-table-column>
              ...
              <el-table-column label="交期" prop="planDate">
                <template slot-scope="scope">
                  <el-date-picker
