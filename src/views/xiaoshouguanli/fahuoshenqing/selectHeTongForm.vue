<template>
  <div class="dialogClass">
    ...
    <el-row style="padding:0 20px;display: flex; flex-direction:column">
      <el-table v-loading="listLoading" :data="param" border style="height:100%;flex:none" :header-cell-style="{background:'#eef1f6',color:'#606266'}" element-loading-text="数据正在努力加载中..." @selection-change="handleSelectionChange">
        <el-table-column
          label="全选"
          type="selection"
          width="80"
