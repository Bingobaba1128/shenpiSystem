  ...
  <el-card>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="销售合同号 :">
                <el-input v-model.trim="queryInfo.contractNo" placeholder="" clearable maxlength="100" @keyup.enter.native="searchDataM" @submit.native.prevent />
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="加工厂名称 :">
                <el-input v-model.trim="queryInfo.supplierName" placeholder="" clearable maxlength="100" @keyup.enter.native="searchDataM" @submit.native.prevent />
              </el-form-item>
            </el-col>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item label="款号 :">
                <el-input v-model.trim="queryInfo.kuanNo" placeholder="" clearable maxlength="100" @keyup.enter.native="searchDataM" @submit.native.prevent />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    <el-row style="padding:0 20px;display: flex; flex-direction:column;height:700px">
      ...
      >
        ...
        <el-table-column label="审批状态" prop="approveState" />
        ...
        <el-table-column label="操作" fixed="right" width="250">
          <template slot-scope="scope">
            ...
            <el-button type="text" :style="{color:((scope.row.approveState !== '待提交' && scope.row.approveState !== '取消' && scope.row.approveState !== '驳回')? none:'#FAAB15')}" :disabled="(scope.row.approveState !== '待提交' && scope.row.approveState !== '取消' && scope.row.approveState !== '驳回')" @click="deleteData(scope.row.purchaseNo)">删除</el-button>
          </template>
        </el-table-column>
...
import { loadData, searchData, deleteRecord, loadYwDept, loadYeWuPerson, uploadData, passData } from '@/api/caigouhetong'
...
export default {
  ...
  methods: {
    ...
    initData(pageSetting) {
      // this.startLoading()
      var url = '/api/Purchase?address_1=1&'
    ...
    editDataM(data) {
      this.$router.push({ path: '/采购合同/采购合同修改', query: { purchaseNo: data.purchaseNo }})
    },
    downLoadM(data) {
      var param = '/api/Purchase/addRows?purchaseNo=' + data.purchaseNo
    ...
    uploadApprove(data) {
      var jsonData = [{
        ...
        style: '采购合同',
        style_1: '1',
        pkNo: data.purchaseNo,
        url: baseUrl + '/#/采购合同/采购合同审批?purchaseNo=' + data.purchaseNo
    ...
    showDataM(data) {
      this.$router.push({ path: '/采购合同/采购合同详情', query: { purchaseNo: data.purchaseNo }})
    },
    closeDialog() {
    ...
    refreshSearch() {
      ...
      this.$set(this.queryInfo, 'contractNo', '')
