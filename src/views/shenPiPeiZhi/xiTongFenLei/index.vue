    ...
    <el-row :gutter="10" style="padding:0 16px; margin-left:0;margin-right:0;padding-bottom:0" class="jiChuPeiZhiClass">
      <el-col style=";padding-left:0;padding-right:0">
        <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="100px" @submit.native.prevent>
          <el-row>
            <el-col span="4.5">
              <el-form-item label="系统分类 :" label-width="90px">
...
import addNewForm from '@/views/shenPiPeiZhi/xiTongFenLei/addNewForm'
import editForm from '@/views/shenPiPeiZhi/xiTongFenLei/eidtNewForm'
...
export default {
  ...
  methods: {
    ...
    // 数据初始化
    initData() {
      var url = '/api/ApproveSystem?flag=1&'
    ...
    editDataM(data) {
      this.editParam = data
      window.console.log(this.editParam)
