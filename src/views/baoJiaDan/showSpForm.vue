<template>
  <el-card class="formStyle">
    ...
    <div style="padding: 15px" class="overWriteStyle">
        ...
        <el-tab-pane label="报价单详情信息">
          ...
          <el-scrollbar style="height: calc(100vh - 415px);">
            <el-row :gutter="10" style="margin-left:0;margin-right:0;padding-bottom:0;padding-top:20px" class="specialColumn">
              <el-form :inline="true" :model="queryInfo" label-position="right" class="demo-form-inline" label-width="90px" style="display:flex; flex-direction:column">
                <el-row>
                  <el-col :span="4">
