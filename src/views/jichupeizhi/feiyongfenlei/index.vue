...
import { loadData, searchData, deleteRecord } from '@/api/feiyongfenlei'
import { combineObject } from '@/utils/combineObject'

import addNewForm from '@/views/jichupeizhi/feiyongfenlei/addNewForm'
import editForm from '@/views/jichupeizhi/feiyongfenlei/eidtNewForm'
