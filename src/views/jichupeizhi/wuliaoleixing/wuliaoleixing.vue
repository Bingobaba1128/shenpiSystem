  ...
  <el-card>
    ...
    <el-row :gutter="10" style="padding:0 16px; margin-left:0;margin-right:0;padding-bottom:0" class="jiChuPeiZhiClass">
      <el-col style=";padding-left:0;padding-right:0">
        <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="100px" @submit.native.prevent>
          <el-row>
            <el-col span="4.5">
              <el-form-item label="物料分类 :" label-width="90px">
            ...
            <el-col span="4.5">
              <el-form-item label="物料类型 :" label-width="90px">
                <el-input v-model.trim="queryInfo.style" placeholder="" clearable maxlength="100" @keyup.enter.native="searchData" @submit.native.prevent />
              </el-form-item>
            </el-col>
    ...
    <el-row style="padding:0 16px;display: flex; flex-direction:column;height:700px">
      ...
      >
        ...
        <el-table-column label="物料分类" prop="classify" width="400" show-overflow-tooltip />
...
import { loadData, searchData, deleteRecord } from '@/api/wuliaoleixing'
import { combineObject } from '@/utils/combineObject'

import addNewForm from '@/views/jichupeizhi/wuliaoleixing/addNewForm'
import editForm from '@/views/jichupeizhi/wuliaoleixing/eidtNewForm'
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      var param1 = '/api/MaterialClassifaction?size=-1'
