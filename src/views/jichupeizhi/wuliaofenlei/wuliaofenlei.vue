          ...
          <el-row>
            <el-col span="4.5">
              <el-form-item label="物料分类 :" label-width="90px">
                <el-input v-model.trim="queryInfo.classify" placeholder="" clearable maxlength="100" @keyup.enter.native="searchData" />
              </el-form-item>
            </el-col>
...
import { loadData, searchData, deleteRecord } from '@/api/wuliaofenlei'
import { combineObject } from '@/utils/combineObject'

import addNewForm from '@/views/jichupeizhi/wuliaofenlei/addNewForm'
import editForm from '@/views/jichupeizhi/wuliaofenlei/eidtNewForm'
...
export default {
  ...
  methods: {
    ...
    initData(pageSetting) {
      ...
      var url = '/api/MaterialClassifaction?'
